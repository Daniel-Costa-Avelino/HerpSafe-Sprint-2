...
('Fernando Vaz de Gouveia - Comercial', 'Criadouro Répteis', '22.212.737/0001-00', 'Micro', 1);
...
INSERT INTO Endereco (Rua, Numero, Complemento, Bairro, Cidade, Estado, CEP, idEmpresa) VALUES
('Rua Contagem', '20', '', 'BETIM INDUSTRIAL', 'Betim', 'MG', '32670-402', 1000),
('Rua Nova Iguacu', '207', '', 'Jardim Marilea', 'Rio das Ostras', 'RJ', '28895-880', 1001),
('Rua Gilson Carlos Mantello', '962', '', 'Sarandi', 'Sarandi', 'PR', '87111-675', 1002), 
('Rua Projetada 560', 'SN', 'Quadra L, Lote 30', 'Ipioca', 'Maceió', 'AL', '57039-839', 1003),
('Rodovia Tildo Mazzarino', 'SN', '', 'Km 43', 'Santa Mônica', 'PR', '87915-000', 1004), 
('Avenida Arvelino Durante', '4728', '', 'Villagio das Palmeiras', 'Sabáudia', 'PR', '86720-000', 1005),
('Av. Arvelino Durante', '4728', '', 'Sabaudia', 'Sabaudia', 'PR', '86.720-000', 1006);
...
FROM reptil
WHERE id_sensor = (SELECT id FROM sensor WHERE nome = 'temperatura ambiente');
